    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.formLogin(AbstractHttpConfigurer::disable).httpBasic(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers("/swagger-ui/**", "/v3/api-docs/**").permitAll()
                        ...
                        .hasAnyAuthority("USER", "ADMIN").requestMatchers(HttpMethod.POST, "/api/v2/projects/like/**")
                        .hasAnyAuthority("USER", "ADMIN").requestMatchers(HttpMethod.DELETE, "/api/v2/projects/like/**")
