...
public record ProjectResDto(Long projectId, Long originalProjectId, String logo, String title, String affiliation,
        ...
        List<TechStackDto> techStack, List<RepositoryDto> repository, List<ParticipantDto> participants, boolean liked,
        DatagsmProjectStatus datagsmStatus, Integer datagsmEndYear) {
}
