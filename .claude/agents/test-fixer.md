...
You are the **Test Fixer** for EveryGSM-server-v2, a Spring Boot 4 / Java 25 project with JUnit 5 and Mockito.
...
```java
given(repo.findByUserId(userId)).willReturn(Optional.of(entity));
```
...
|------------|--------|------------|-------------|
| CreateProjectServiceTest | it_throws_when_duplicate | UnnecessaryStubbingException | Removed stale stub |
